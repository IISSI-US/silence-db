...
const hobbiesAPI_auto = {
    ...
    getById: async function(hobby_id) {
        let response = await axios.get(`${BASE_URL}/hobbies/${hobby_id}`, requestOptions);
    ...
    update: async function(formData, hobby_id) {
        let response = await axios.put(`${BASE_URL}/hobbies/${hobby_id}`, formData, requestOptions);
        return response.data;
    },

    /** Deletes an existing entry in 'hobbies' by its primary key */
    delete: async function(hobby_id) {
        let response = await axios.delete(`${BASE_URL}/hobbies/${hobby_id}`, requestOptions);
        return response.data;
    },
};
