...
const usersAPI_auto = {
    ...
    getById: async function(user_id) {
        let response = await axios.get(`${BASE_URL}/users/${user_id}`, requestOptions);
    ...
    update: async function(formData, user_id) {
        let response = await axios.put(`${BASE_URL}/users/${user_id}`, formData, requestOptions);
        return response.data;
    },

    /** Deletes an existing entry in 'users' by its primary key */
    delete: async function(user_id) {
        let response = await axios.delete(`${BASE_URL}/users/${user_id}`, requestOptions);
        return response.data;
    },
};
