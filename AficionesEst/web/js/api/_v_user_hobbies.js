...
const v_user_hobbiesAPI_auto = {

    /** Gets all entries from 'v_user_hobbies' */
    getAll: async function() {
        let response = await axios.get(`${BASE_URL}/v_user_hobbies`, requestOptions);
        return response.data;
    },
};

export { v_user_hobbiesAPI_auto };